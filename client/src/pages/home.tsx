              ...
              <div className="sticky top-24">
                <div className="glass-effect rounded-2xl p-6 mb-4">
                  <div className="text-center">
                    <Avatar className="w-20 h-20 mx-auto mb-4 border-2 border-primary" data-testid="sidebar-user-avatar">
                      <AvatarImage src={user.profilePictureUrl || undefined} alt={user.name} />
                      <AvatarFallback className="text-2xl">{user.name.charAt(0).toUpperCase()}</AvatarFallback>
                    </Avatar>
                    <h3 className="font-semibold text-lg" data-testid="sidebar-user-name">{user.name}</h3>
                    <p className="text-sm text-muted-foreground mb-4" data-testid="sidebar-user-bio">
                      {user.bio || 'Professional • EchoMateLite Member'}
                    </p>
                    <div className="grid grid-cols-2 gap-4 text-center pt-4 border-t border-border">
                      <div>
                        <p className="text-xl font-bold" data-testid="sidebar-followers-count">247</p>
                        <p className="text-xs text-muted-foreground">Followers</p>
                      </div>
                      <div>
                        <p className="text-xl font-bold" data-testid="sidebar-following-count">189</p>
                ...
                <div className="glass-effect rounded-2xl p-4">
                  ...
                  <div className="space-y-2">
                    <a href="#" className="flex items-center gap-3 p-2 rounded-lg hover:bg-accent/10 transition-colors text-sm">
            ...
            <main className="lg:col-span-6">
              ...
              <div className="glass-effect rounded-2xl p-6 mb-6">
                <div className="flex items-center gap-4 mb-4">
                  <Avatar className="w-12 h-12" data-testid="create-post-trigger-avatar">
                    <AvatarImage src={user.profilePictureUrl || undefined} alt={user.name} />
              ...
              {isLoading ? (
                ...
                <div className="glass-effect rounded-2xl p-6 text-center">
                  <p className="text-muted-foreground" data-testid="text-no-posts">No posts yet. Create your first post!</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {posts.map((post) => (
            ...
            <aside className="lg:col-span-3 hidden lg:block">
              <div className="sticky top-24 space-y-4">
                ...
                <div className="glass-effect rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={i} className="cursor-pointer hover:bg-accent/10 p-2 rounded-lg transition-colors" data-testid={`trending-topic-${i}`}>
                ...
                <div className="glass-effect rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { name: 'David Park', role: 'Frontend Dev', avatar: 'DP' },
                      { name: 'Lisa Anderson', role: 'UI/UX Designer', avatar: 'LA' },
                      { name: 'James Wilson', role: 'Tech Lead', avatar: 'JW' }
                    ].map((person, i) => (
                      <div key={i} className="flex items-center gap-3" data-testid={`suggestion-${i}`}>
                        ...
                        <Button size="sm" variant="outline" className="text-xs" data-testid={`button-follow-${i}`}>
                          Follow
                        </Button>
                      </div>
                    ))}
