        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-primary flex items-center justify-center">
              <MessageCircle className="w-6 h-6 text-primary-foreground" strokeWidth={2} />
            </div>
            <span className="text-xl font-bold hidden sm:block">EchoMateLite</span>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center gap-6">
            <Link href="/">
              <a className={`nav-link flex flex-col items-center gap-1 transition-colors ${
            ...
            <Link href="/notifications">
              <a className={`nav-link flex flex-col items-center gap-1 transition-colors relative ${
